...
class _TelaConsultaExtintorState extends State<TelaConsultaExtintor> {
  ...
  Future<void> _fetchPatrimoniosDisponiveis() async {
    ...
    try {
      final url = Uri.parse(
          'http://10.0.2.2:3001/patrimonio'); // Substitua 10.0.2.2 pelo IP da sua máquina
  ...
  Future<void> _buscarExtintor() async {
    ...
    final url = Uri.parse(
        'http://10.0.2.2:3001/extintor/$_patrimonio'); // Substitua 10.0.2.2 pelo IP da sua máquina
